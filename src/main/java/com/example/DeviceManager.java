...
public class DeviceManager extends AbstractBehavior<DeviceManager.Command> {
    ...
    public static final class RequestTrackDevice implements DeviceGroup.Command, DeviceManager.Command {
        public final String groupId;
        public final String deviceId;
        public final ActorRef<DeviceRegistered> replyTo;

        RequestTrackDevice(String groupId, String deviceId, ActorRef<DeviceRegistered> replyTo) {
